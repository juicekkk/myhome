...
<div id="leftWrap">
    ...
    <hr style="display: block; background: #0d7f36; height: 5px; margin: 0 auto; border: navajowhite; width: 80%; border-radius: 15%;" />
    <br>
    ...
    <div style="position: absolute; bottom: 0; width: 100%; height: 40px; background-color: #0d7f36;"></div>
</div>
